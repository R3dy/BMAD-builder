...
**Goal:** Define the product completely before any research or building begins. When Phase 0 is complete, both you and the AI know exactly what we're building, why it will make money, and what success looks like.
...
The AI drafts a complete version based on whatever you provide. Do not ask for more input — make a recommendation and ask for corrections.
...
- **Product Owner:** You — make all product and business decisions, approve phase gates
- **Developer:** The AI — builds, plans, executes, reports
...
Review `PROJECT.md`. Key questions:
...
Say "looks good, start Discovery" → proceed to Phase 1.
